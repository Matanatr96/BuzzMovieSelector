package findteamname.buzzmovieselector.database;
...
/**
 * Created by alexherbig on 3/13/16.
 */
...
//            Log.d("CONNECTION RESULT:", rs.toString());
//            while (rs.next()) {
//                String movieId = rs.getString("MovieID");
//                Log.d("MOVIERESULT:", movieId);
//            }
//        }
//        catch (Exception e) {
//            Log.d("callDB: error   :   :  ", e.getMessage());
//        }
//    }
//}
